...
**Tests**: Tests are MANDATORY for this project. Include failing-first unit,
contract, integration, and secret-redaction tasks for every affected user story.
Coverage MUST remain at or above the constitutional threshold.
...
- [ ] T010 Add shared logger wrapper with Pino/loglevel boundary, redaction,
  level mapping, localized developer formatting, and stderr destination for MCP
  stdio operation
- [ ] T011 [P] Add logger tests for level defaults, redaction, localized
  developer timestamps, stdout avoidance, and no direct console usage in
  application code
...
- [ ] T019 [US1] Add logging through the shared logger wrapper only
...
- [ ] TXXX [P] Additional unit, contract, integration, and secret-redaction tests
