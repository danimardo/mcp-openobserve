# Instrucciones para agentes de IA — mcp-openobserve

Este fichero define las instrucciones de trabajo para cualquier agente de IA que colabore en este proyecto: OpenAI Codex, Cursor, Windsurf, Aider, Continue, y otros agentes compatibles con el estándar `AGENTS.md`.
